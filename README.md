...
15. shade_spot(image, region, intensity=0.8): Creates light or dark shaded areas within rectangular regions by darkening/brightening pixels based on an "intensity" factor to create subtle shadows and highlights. 
16. motion_line(base_img, overlay_img, start=(25, 75), end=(300, 400)): Blurs the area behind moving objects in a base image by applying Gaussian blur along lines connecting specified starting/ending points (e.g., simulating streaks of movement).
